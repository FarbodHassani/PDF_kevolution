...
\begin{figure}[H]
 ...
 \end{figure}
 \subsubsection{Make the same plot at z=0} 
...
%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%
\subsubsection{Comparing obtained $\Phi'$ from full second order matter and Poisson equation at two different redshifts with the one we have obtained from Riess Sciama effect {\color{red} To do!}}
